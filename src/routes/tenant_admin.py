...
def get_db_connection():
    ...
    context, track_start = track_connection_acquired("tenant_admin.py::get_db_connection")
    ...
    try:
        ...
        stats = conn.execute("""
            SELECT 
                ...
                SUM(CASE WHEN status IN ('won', 'lost', 'void') THEN stake ELSE 0 END) as total_staked,
