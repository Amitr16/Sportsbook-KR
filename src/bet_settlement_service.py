...
class BetSettlementService:
    ...
    def _calculate_casino_revenue(self, operator_id):
        ...
        try:
            ...
            result = current_app.db.session.execute(text(casino_query), {'operator_id': operator_id}).fetchone()
    ...
    def _calculate_sportsbook_revenue(self, operator_id):
        ...
        try:
            ...
            result = current_app.db.session.execute(text(sportsbook_query), {'operator_id': operator_id}).fetchone()
